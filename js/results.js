...
Estimated Avg System Cost: ₹${result.totalCost.toLocaleString('en-IN')}
...
if (DEV_CONFIG.otpEnabled) {
    ...
    window.open(`https://wa.me/919235169031?text=Hi,%20I%20need%20manual%20verification%20assistance%20for%20Lead%20Code:%20${currentLeadCode}`, "_blank");
    modal.remove();
    return;
}
